...
<body>
 <div class="container-fluid">
   ...
   <div class="col-12">
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: gold">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        <a class="navbar-brand" href="#" style="color: white; font-weight: bold">SPK TEMPAT KOST</a>
  ...
  <div class="row" style="margin-top:10px">
   ...
   Selamat Datang di SPK Pemilihan Tempat Kost dengan Metode SAW
   </div>
  ...
  <div class="row">
   <div class="col-12">
    <div class="d-flex justify-content-center">
     &copy;opyright Kel 12-SPK TEMPAT KOST 2021
    </div>
   </div>
  </div>
